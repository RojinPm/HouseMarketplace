...
function CreateListing() {
  ...
  //  Google geocode part for map feature
 ...
 console.log(data);
  ...
  //  ?? -Whenever the value of the left is null 
  //then take the value on the right
         ...
         <div>
          ...
          <label htmlFor="" className="formLabel">Parking spot</label>
           <div className="formButtons">
              ...
              <button className={parking ? 'formButtonActive' :
              'formButton'}
               type="button"
               id='parking'
               value={true}
 ...
 <button className={!parking && parking !== null ? 'formButtonActive' :
              'formButton'}
               type="button"
               id='parking'
                value={false}
    ...
    <label htmlFor="" className="formLabel">Furnished</label>
           <div className="formButtons">
              ...
              <button className={furnished ? 'formButtonActive' :
              'formButton'}
               type="button"
               id='furnished'
               value={true}
 ...
 <button className={!furnished && furnished !== null ? 'formButtonActive' :
              'formButton'}
               type="button"
               id='furnished'
                value={false}
